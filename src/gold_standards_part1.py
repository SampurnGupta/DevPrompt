...
DEBUG_GENERATE = {
    "debug_001": {
        ...
        "intent_preservation_reference": "Fix the database connection timeout that causes an infinite loop.",
    ...
    "debug_002": {
        ...
        "intent_preservation_reference": "Fix the KeyError when merging two pandas DataFrames.",
    ...
    "debug_003": {
        ...
        "intent_preservation_reference": "Fix the NullPointerException in the login service.",
        "expected_tools": ["search_codebase", "read_file", "write_file", "run_tests"],
        "minimum_required_tools": ["read_file", "write_file"],
    ...
    "debug_004": {
        ...
        "intent_preservation_reference": "Fix the Docker container OOM crash (exit code 137).",
    ...
    "debug_005": {
        ...
        "intent_preservation_reference": "Fix the Android app crash when uploading an image.",
        "expected_tools": ["search_codebase", "read_file", "write_file", "run_tests"],
        "minimum_required_tools": ["read_file", "write_file"],
    ...
    "debug_006": {
        ...
        "intent_preservation_reference": "Fix the RuntimeException and memory leak in the order handler.",
        "expected_tools": ["search_codebase", "read_file", "write_file", "run_tests"],
        "minimum_required_tools": ["read_file", "write_file"],
    ...
    "generate_001": {
        ...
        "intent_preservation_reference": "Create a dropdown menu component in React.",
    ...
    "generate_002": {
        ...
        "intent_preservation_reference": "Write a JWT authentication middleware for Django.",
    ...
    "generate_003": {
        ...
        "intent_preservation_reference": "Write a pandas script to clean and normalize a CSV file.",
    ...
    "generate_004": {
        ...
        "intent_preservation_reference": "Generate a user registration REST endpoint in Express.js.",
    ...
    "generate_005": {
        ...
        "intent_preservation_reference": "Write a bash script to automate daily backups.",
    ...
    "generate_006": {
        ...
        "intent_preservation_reference": "Write a SQL query to get the top 10 customers by spend.",
        "expected_tools": ["fetch_docs", "write_file"],
        "minimum_required_tools": ["write_file"],
