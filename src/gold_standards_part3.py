...
SCAFFOLD_TEST_DOCUMENT_COMPOSITE = {
    "scaffold_001": {
        ...
        "intent_preservation_reference": "Scaffold a Node.js Express app with Next.js and TypeScript.",
    ...
    "scaffold_002": {
        ...
        "intent_preservation_reference": "Scaffold a Flutter app with Firebase and a FastAPI backend.",
        "expected_tools": ["execute_shell", "write_file", "fetch_docs"],
        "minimum_required_tools": ["write_file"],
    ...
    "scaffold_003": {
        ...
        "intent_preservation_reference": "Scaffold a Django project with REST Framework and authentication.",
        "expected_tools": ["execute_shell", "write_file", "fetch_docs"],
        "minimum_required_tools": ["write_file"],
    ...
    "scaffold_004": {
        ...
        "intent_preservation_reference": "Scaffold a Terraform project for AWS with Prometheus monitoring.",
    ...
    "scaffold_005": {
        ...
        "intent_preservation_reference": "Create a monorepo with a shared component library.",
        "expected_tools": ["execute_shell", "write_file", "fetch_docs"],
        "minimum_required_tools": ["write_file"],
    ...
    "scaffold_006": {
        ...
        "intent_preservation_reference": "Scaffold a Jupyter + Conda project with a FastAPI backend.",
        "expected_tools": ["execute_shell", "write_file", "fetch_docs"],
        "minimum_required_tools": ["write_file"],
    ...
    "test_001": {
        ...
        "intent_preservation_reference": "Write tests for the checkout flow.",
        "expected_tools": ["read_file", "write_file", "run_tests"],
        "minimum_required_tools": ["write_file", "run_tests"],
    ...
    "test_002": {
        ...
        "intent_preservation_reference": "Write unit tests that mock the Stripe API for the payment service.",
    ...
    "test_003": {
        ...
        "intent_preservation_reference": "Write Jest unit tests for the login service.",
        "expected_tools": ["read_file", "fetch_docs", "write_file", "run_tests"],
        "minimum_required_tools": ["write_file", "run_tests"],
    ...
    "test_004": {
        ...
        "intent_preservation_reference": "Write Locust load tests for the search endpoint.",
    ...
    "test_005": {
        ...
        "intent_preservation_reference": "Write tests for the data validation functions.",
        "expected_tools": ["read_file", "write_file", "run_tests"],
        "minimum_required_tools": ["write_file", "run_tests"],
    ...
    "test_006": {
        ...
        "intent_preservation_reference": "Write a pytest fixture for the database connection.",
        "expected_tools": ["read_file", "fetch_docs", "write_file", "run_tests"],
        "minimum_required_tools": ["write_file"],
    ...
    "document_001": {
        ...
        "intent_preservation_reference": "Add inline comments to the payment processing code.",
    ...
    "document_002": {
        ...
        "intent_preservation_reference": "Document environment variables and project setup in the README.",
        "expected_tools": ["read_file", "write_file"],
        "minimum_required_tools": ["read_file", "write_file"],
    ...
    "document_003": {
        ...
        "intent_preservation_reference": "Write JSDoc comments for all public functions in the API module.",
    ...
    "document_004": {
        ...
        "intent_preservation_reference": "Write CHANGELOG entries for the new release version.",
    ...
    "document_005": {
        ...
        "intent_preservation_reference": "Add docstrings to Python data processing functions.",
        "expected_tools": ["read_file", "write_file", "lint_code"],
        "minimum_required_tools": ["read_file", "write_file"],
    ...
    "document_006": {
        ...
        "intent_preservation_reference": "Create a Postman collection and Swagger spec for all API endpoints.",
    ...
    "composite_001": {
        ...
        "intent_preservation_reference": "Fix the NullPointerException in the user service and write regression unit tests.",
    ...
    "composite_002": {
        ...
        "intent_preservation_reference": "Refactor the payment service for separation of concerns and document the changes.",
    ...
    "composite_003": {
        ...
        "intent_preservation_reference": "Explain the Kafka consumer lag and generate an async fix.",
        "expected_tools": ["read_file", "fetch_docs", "write_file", "run_tests"],
        "minimum_required_tools": ["read_file", "write_file"],
    ...
    "composite_004": {
        ...
        "intent_preservation_reference": "Scaffold an order management microservice and write integration tests.",
    ...
    "composite_005": {
        ...
        "intent_preservation_reference": "Fix the memory leak in the connection pool and document the cause and fix.",
        "expected_tools": ["search_codebase", "read_file", "write_file", "run_tests"],
        "minimum_required_tools": ["read_file", "write_file"],
    ...
    "composite_006": {
        ...
        "intent_preservation_reference": "Generate a user profile update endpoint and explain its auth middleware integration.",
        "expected_tools": ["read_file", "fetch_docs", "write_file", "run_tests"],
        "minimum_required_tools": ["write_file"],
