...
REFACTOR_EXPLAIN = {
    "refactor_001": {
        ...
        "intent_preservation_reference": "Refactor the monolithic API into smaller, separate microservices. Solution must extract auth, orders, and users into independent modules with clear interfaces.",
        ...
        "alternative_tool_sequences": [
            ["read_file", "search_codebase", "write_file", "git_diff"],
    ...
    "refactor_002": {
        ...
        "intent_preservation_reference": "Rename variables in the config module to be more descriptive. Solution must replace cryptic variable names with descriptive, self-documenting names following conventions.",
    ...
    "refactor_003": {
        ...
        "intent_preservation_reference": "Refactor the user controller to use the Strategy design pattern. Solution must encapsulate behaviors in strategy classes, reducing conditionals.",
        "expected_tools": ["search_codebase", "read_file", "write_file", "lint_code"],
        "minimum_required_tools": ["read_file", "write_file"],
        "alternative_tool_sequences": [
            ["read_file", "search_codebase", "write_file", "lint_code"],
            ["search_codebase", "read_file", "write_file"],
            ["read_file", "write_file", "lint_code"]
        ],
    ...
    "refactor_004": {
        ...
        "intent_preservation_reference": "Refactor the auth service to use async/await syntax. Solution must convert callback/promises to async/await, ensuring try/catch block error handling.",
    ...
    "refactor_005": {
        ...
        "intent_preservation_reference": "Extract validation logic into a separate dedicated module. Solution must move validations to validators.py (or similar) and update all import references.",
    ...
    "refactor_006": {
        ...
        "intent_preservation_reference": "Simplify and reduce complexity of the payment processing logic. Solution must break logic into single-responsibility functions, removing duplication.",
        "expected_tools": ["read_file", "write_file", "lint_code", "git_diff"],
        "minimum_required_tools": ["read_file", "write_file"],
        "alternative_tool_sequences": [
            ["read_file", "write_file", "git_diff"],
    ...
    "explain_001": {
        ...
        "intent_preservation_reference": "Explain how the caching layer interacts with the database and database indexing. Explanation must cover cache-aside/write-through and B-tree/hash indexing.",
        "expected_tools": ["read_file", "fetch_docs", "search_codebase"],
        "minimum_required_tools": ["read_file"],
        "alternative_tool_sequences": [
            ["read_file"],
            ["fetch_docs"],
            ["read_file", "fetch_docs"],
    ...
    "explain_002": {
        ...
        "intent_preservation_reference": "Explain how the Express middleware stack interacts with OAuth authentication. Explanation must cover request sequence, OAuth2 token verification, and next().",
    ...
    "explain_003": {
        ...
        "intent_preservation_reference": "Explain what the regex pattern does and what it matches. Explanation must break down tokens and show examples of matching and non-matching strings.",
        "expected_tools": ["fetch_docs", "execute_shell"],
        "minimum_required_tools": ["fetch_docs"],
        "alternative_tool_sequences": [
            ["fetch_docs"],
            ["execute_shell"],
            ["fetch_docs", "execute_shell"]
        ],
    ...
    "explain_004": {
        ...
        "intent_preservation_reference": "Explain the difference between Docker and Kubernetes. Explanation must cover containerization vs orchestration, scaling, and service discovery.",
    ...
    "explain_005": {
        ...
        "intent_preservation_reference": "Explain the difference between Promises and async/await in JavaScript. Explanation must cover syntactic sugar, then/catch vs try/catch, and readability tradeoffs.",
        "expected_tools": ["fetch_docs"],
        "minimum_required_tools": ["fetch_docs"],
        "alternative_tool_sequences": [
            ["fetch_docs"]
    ...
    "explain_006": {
        ...
        "intent_preservation_reference": "Explain why Redux is being used in this project. Explanation must cover global state management, predictable updates, and why Context API was insufficient.",
        "expected_tools": ["read_file", "fetch_docs"],
        "minimum_required_tools": ["read_file"],
        "alternative_tool_sequences": [
            ["read_file"],
